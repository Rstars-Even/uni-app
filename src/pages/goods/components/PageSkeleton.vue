  ...
  <view class="sk-container">
    <scroll-view scroll-y="true" class="viewport">
      <view class="goods">
        ...
        <view class="meta">
          <view class="price">
            ...
            <text class="number sk-transparent sk-text-14-2857-338 sk-text">18.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-87 sk-text"
            >若羌红枣脆片138克</view
          >
          <view class="desc sk-transparent sk-text-0-0000-813 sk-text">片片枣干，口口甘香app</view>
        </view>
        <view class="action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-302 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-146 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-853 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-660 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-437 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-307 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail panel">
        <view class="title">
          <text class="sk-transparent sk-text-0-0000-847 sk-text">详情</text>
        </view>
        <view class="content">
          <view class="properties">
            <view class="item">
              <text class="label sk-transparent sk-text-25-0000-206 sk-text">包装</text>
              <text class="value sk-transparent sk-text-25-0000-870 sk-text">罐装</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-371 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-398 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
